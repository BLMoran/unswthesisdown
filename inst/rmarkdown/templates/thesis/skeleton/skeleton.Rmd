...
author: 'Your R. Name'
date: 'May 20xx'
division: 'Climate Change Research Centre'
school: 'Biological, Earth & Environmental Sciences'
faculty: 'Science'
institution: 'UNSW Sydney'
supervisors: 'Advisor F. Name'
degree: 'Doctor of Philosophy'
title: 'My Thesis Name'
logo: 'forms/UNSWcrest'

# output options. use gitbook while you're writing; switch to pdf when you're
# ready to make it look pretty. word and epub aren't great atm.
knit: "bookdown::render_book"
site: bookdown::bookdown_site
output: 
  unswthesisdown::thesis_pdf: default
  unswthesisdown::thesis_gitbook: default
#  unswthesisdown::thesis_word: default
#  unswthesisdown::thesis_epub: default

# abstract and other preliminary content. comment out if you don't want it!
abstract: |
  `r if(knitr:::is_latex_output()) paste(readLines("00-abstract.Rmd"), collapse = '\n  ')`
# If you'd rather include the preliminary content in a file instead of here,
# use a command like that for the abstract above.  Note that a tab is needed on
# the line after the |.
acknowledgements: |
...
bibliography: bib/thesis.bib # bib file (or files, in an [array])
csl: csl/apa.csl  # citation style file
link-citations: true # hyperlinks between citations and reference list
lot: true # lists of tables and figures after the toc
lof: true

#space_between_paragraphs: true

# uncomment this to add more latex packages
#header-includes:
#- \usepackage{tikz}
---
...
# This chunk ensures that the unswthesisdown package is
# installed and loaded. This unswthesisdown package includes
# the template files for the thesis.
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(unswthesisdown))
  devtools::install_github("rensa/unswthesisdown")
library(unswthesisdown)

# set default options for code chunks. these options are good for if
# you mostly use chunks for figures and tables, but experiment with them
# (and remember you can override them in each chunk!)
# refer to https://yihui.name/knitr/options/ for more options
opts_chunk$set(echo = FALSE, out.width = "85%", fig.align = "center")
```

<!-- You'll need to include the order that you'd like Rmd files to appear in
the _bookdown.yml file for PDF files and also delete the # before rmd_files:
there. You'll want to not include 00(two-hyphens)prelim.Rmd and
00-abstract.Rmd since they are handled in the YAML above differently for the
PDF version. -->
